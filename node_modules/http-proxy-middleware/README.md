...
View the [students](https://github.com/chimurai/http-proxy-middleware/tree/master/students) for common use cases.
...
Sample implementations can be found in the [server students](https://github.com/chimurai/http-proxy-middleware/tree/master/students/servers.md).
